  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setToast({
        ...
        message: 'Your account has been created. Redirecting you to the dashboard.',
        variant: 'success',
      })
      ...
      setToast({
        title: 'Signup failed',
        message: getErrorMessage(error, 'Please try again with different credentials.'),
        variant: 'error',
      })
    } finally {
      setLoading(false)
        ...
        <section className="grid gap-6 overflow-hidden rounded-3xl border border-white/10 bg-slate-900/70 shadow-2xl shadow-slate-950/30 lg:grid-cols-[1fr_0.9fr]">
          <div className="flex flex-col justify-between gap-8 border-b border-white/10 p-6 sm:p-8 lg:border-b-0 lg:border-r">
            ...
            <div className="space-y-4">
              <h1 className="max-w-xl text-3xl font-semibold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Create your account and unlock dashboard access.
              </h1>
          ...
          <div className="p-6 sm:p-8">
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-slate-400">Join to manage your URLs and analytics.</p>
            </div>
