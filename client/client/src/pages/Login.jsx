          ...
          <div className="flex flex-col justify-between gap-8 border-b border-white/10 p-6 sm:p-8 lg:border-b-0 lg:border-r">
            ...
            <div className="grid gap-3 text-sm text-slate-400 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-1">Stored locally after a successful login.</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                <p className="font-semibold text-white">Dashboard</p>
                <p className="mt-1">Redirects to the main URL management view.</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                <p className="font-semibold text-white">Security</p>
                <p className="mt-1">Email and password are validated before submit.</p>
              </div>
            </div>
          </div>
